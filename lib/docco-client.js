(function() {
  var $doc, $menu, $page, CREATE, DELETE, EMPTY, NAV, PURGE, READ, SEARCH, SHOW, UPDATE, follow, log, mode, navigate, prevent, search, select, setup, stop, store, _mode;
