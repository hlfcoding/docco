(function() {
  var $doc, $menu, $page, CREATE, DELETE, EMPTY, NAV_MODE, PURGE, READ, READ_MODE, SEARCH_MODE, UPDATE, docco, log, mode, search, select, setup, store, _mode;
  ...
  setup = function() {
    ...
    $doc.bind('keydown', 't', function(e) {
      ...
      var $selected, _ref;
      if (((_ref = mode()) === NAV_MODE || _ref === SEARCH_MODE) && ($selected = $menu.$selectedItem()).length) {
