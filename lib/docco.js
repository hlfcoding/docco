(function() {
  ...
  generate_html = function(source, sections, jump_menu_html) {
    var dest, html, title;
    ...
    if (!conf.quiet) console.log("docco: " + source + " -> " + dest);
