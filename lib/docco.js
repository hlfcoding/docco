(function() {
  var arg, args, base_path, base_pattern, conf, destination, dir_pattern, docco_client_scripts, docco_styles, docco_template, ensure_directory, exec, ext, file_pattern, fs, generate_documentation, generate_html, get_directory_files, get_language, highlight, highlight_end, highlight_start, l, languages, parse, path, run_script, showdown, skipped, sources, spawn, template, type_pattern, walk, _ref;
  ...
  destination = function(filepath) {
    return filepath = path.basename(filepath) === conf.index_file ? 'docs/index.html' : "docs/" + (filepath.replace(/\//g, '.')) + ".html";
  };
